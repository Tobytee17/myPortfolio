<template>
  <div class="blogPost">
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-12" v-for="article in articles" v-if="article.link == $route.params.articleID">
        <div class="well">
          <div class="page-header">
            <h1 v-text="article.title"></h1>
            <small v-text="article.date"></small>
          </div>
          <br>
