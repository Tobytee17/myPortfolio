<template>
  <div class="blog">
    <div class="row">
      <div class="col-sm-12 col-md-12 col-lg-12" v-for="post in posts">
        <div class="well">
          <div class="page-header">
            <h1><router-link :to="post.link" v-text="post.title"></router-link></h1><small v-text="post.date"></small>
          </div>
          <p v-text="post.summary"></p>
        </div>
      </div>
    </div>
  </div>
